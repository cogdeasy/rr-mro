...
import { createRequest, getEngineTypes, getMroOrganisations, getAnomalyTypes } from '../../shared/services/api';
...
export default function Submit() {
  ...
  useEffect(() => {
    getEngineTypes().then(d => setEngineTypes(d));
    getMroOrganisations().then(d => setMroOrganisations(d));
    getAnomalyTypes().then(d => setAnomalyTypes(d));
  }, []);
  ...
  function onSubmit(e: React.FormEvent) {
    e.preventDefault();
    setSubmitting(true);
    createRequest(form as Record<string, unknown>).then(r => {
      setSubmitted(true);
      setSubmitting(false);
            ...
            <form onSubmit={onSubmit}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                <div className="form-group" style={{ gridColumn: 'span 2' }}>
                  ...
                  <input type="text" name="title" value={form.title} onChange={handleChange} placeholder="e.g. HPT Blade Tip Liberation — Trent XWB SN-7842" required />
                </div>
                <div className="form-group" style={{ gridColumn: 'span 2' }}>
                ...
                <div className="form-group">
                  ...
                  <select name="anomalyType" value={form.anomalyType} onChange={handleChange} required>
                ...
                <div className="form-group">
                  ...
                  <select name="engineType" value={form.engineType} onChange={handleChange} required>
                ...
                <div className="form-group">
                  ...
                  <input type="text" name="engineSerialNumber" value={form.engineSerialNumber} onChange={handleChange} placeholder="e.g. SN-7842" required />
                </div>
                <div className="form-group">
                  <label>Part Number</label>
                  <input type="text" name="partNumber" value={form.partNumber} onChange={handleChange} placeholder="e.g. RB211-9278" />
                </div>

                <div className="form-group">
                  <label>Aircraft Registration</label>
                  <input type="text" name="aircraftRegistration" value={form.aircraftRegistration} onChange={handleChange} placeholder="e.g. G-XWBA" />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <select name="mroOrganisation" value={form.mroOrganisation} onChange={handleChange} required>
                ...
                <div className="form-group">
                  ...
                  <input type="text" name="mroSiteLocation" value={form.mroSiteLocation} onChange={handleChange} placeholder="e.g. Hamburg, Germany" />
                </div>

                <div className="form-group">
                  <label>Shop Visit Reference</label>
                  <input type="text" name="shopVisitReference" value={form.shopVisitReference} onChange={handleChange} placeholder="e.g. SV-2025-LHT-0042" />
                </div>
                <div className="form-group">
                  <label>Submitted By *</label>
                  <input type="text" name="submittedBy" value={form.submittedBy} onChange={handleChange} placeholder="e.g. M. Weber" required />
                </div>
              </div>
