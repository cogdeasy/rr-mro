...
import { getRequests, triageRequest, generateDocument } from '../../../shared/services/api';
...
export default function AiAssist() {
  ...
  function runAgent() {
    ...
    const promise = selectedAgent === 'triage'
      ? triageRequest(selectedRequestId)
      : generateDocument(selectedRequestId, 'Dr. J. Richardson');
        ...
        <div style={{ display: 'flex', alignItems: 'start', gap: '0.75rem' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.8125rem', color: 'var(--rr-muted)', lineHeight: 1.6 }}>
              The AI Assist platform uses <strong>Azure OpenAI GPT-4</strong> with <strong>Retrieval Augmented Generation (RAG)</strong> on <strong>Databricks</strong>. The knowledge base includes 15,000+ historical variance resolutions,
