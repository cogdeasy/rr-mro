        ...
        <>
          <div className="kpi-row">
            <div className="kpi-card">
              ...
              <div className="kpi-bar"><div className="kpi-fill" style={{ width: '100%', background: '#3B82F6' }}></div></div>
            </div>
            <div className="kpi-card">
              <div className="kpi-header">
              ...
              <div className="kpi-bar"><div className="kpi-fill" style={{ width: `${((stats.totalRequests - stats.completed) / stats.totalRequests) * 100}%`, background: '#F59E0B' }}></div></div>
            </div>
            <div className="kpi-card">
              <div className="kpi-header">
              ...
              <div className="kpi-bar"><div className="kpi-fill" style={{ width: `${(stats.completed / stats.totalRequests) * 100}%`, background: '#10B981' }}></div></div>
            </div>
            <div className="kpi-card">
              <div className="kpi-header">
              ...
              <div className="kpi-value">{formatNumber(stats.avgResolutionDays)}<span className="kpi-unit">days</span></div>
              <div className="kpi-bar"><div className="kpi-fill" style={{ width: '60%', background: '#8B5CF6' }}></div></div>
            </div>
            <div className="kpi-card">
              <div className="kpi-header">
              ...
              <div className="kpi-bar"><div className="kpi-fill" style={{ width: '65%', background: '#B8860B' }}></div></div>
            </div>
          </div>
            ...
            <div className="pipeline">
              {workflowStages.map((stage, i) => (
                <div className="pipeline-stage" key={stage.name}>
                  ...
                  {i < workflowStages.length - 1 && <div className="stage-arrow">&#8594;</div>}
                </div>
              ))}
            </div>
          </div>
                ...
                {engineEntries.map(item => (
                  <div className="bar-row" key={item[0]}>
                    ...
                    <div className="bar-track">
                      <div className="bar-fill navy" style={{ width: `${getBarWidth(item[1])}%` }}></div>
                    </div>
              ...
              <div className="bar-chart">
                {mroEntries.map(item => (
                  <div className="bar-row" key={item[0]}>
                    <span className="bar-label">{item[0]}</span>
                    <div className="bar-track">
                      <div className="bar-fill gold" style={{ width: `${getMroBarWidth(item[1])}%` }}></div>
                    </div>
                    <span className="bar-val">{item[1]}</span>
                  </div>
                ))}
                ...
                {priorityEntries.map(item => (
                  <div className="priority-row" key={item[0]}>
                    <div className="priority-info">
                      <span className={`priority-dot ${item[0].toLowerCase()}`}></span>
            ...
            <div className="card">
              ...
              <div className="trend-list">
                {stats.monthlyTrend.map(m => (
                  <div className="trend-row" key={m.month}>
                    ...
                    <div className="trend-bars">
                      <div className="trend-bar submitted" style={{ width: `${m.submitted * 20}px` }} title={`Submitted: ${m.submitted}`}></div>
                      <div className="trend-bar resolved" style={{ width: `${m.resolved * 20}px` }} title={`Resolved: ${m.resolved}`}></div>
                    </div>
                ...
                <div className="trend-legend">
                  <span className="legend-item"><span className="legend-dot sub"></span>Submitted</span>
                  <span className="legend-item"><span className="legend-dot res"></span>Resolved</span>
                </div>
              </div>
            </div>
            <div className="card">
