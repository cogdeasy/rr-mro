...
import { getRequest, updateStatus, triageRequest, generateDocument, addComment } from '../../../shared/services/api';
import { STATUS_LABELS, STATUS_CSS } from '../../../shared/models/variance-request.model';
import type { VarianceRequest } from '../../../shared/models/variance-request.model';
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '0.5rem' }}>
          {!request.triageResult && (
            <button className="btn-navy" onClick={handleRunTriage} style={{ fontSize: '0.8125rem', padding: '0.5rem 1rem' }}>
              Run AI Triage
            </button>
          )}
          {!request.generatedDocument && (
            <button className="btn-navy" onClick={handleGenerateDoc} style={{ fontSize: '0.8125rem', padding: '0.5rem 1rem' }}>
              Generate Document
            </button>
          )}
        </div>
