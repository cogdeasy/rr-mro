...
import { createRequest, getEngineTypes, getMroOrganisations, getAnomalyTypes } from '../services/api';
            ...
            <form onSubmit={onSubmit}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                <div className="form-group" style={{ gridColumn: 'span 2' }}>
                  ...
                  <input type="text" value={form.title} onChange={e => updateField('title', e.target.value)} placeholder="e.g. HPT Blade Tip Liberation — Trent XWB SN-7842" required />
                </div>
                <div className="form-group" style={{ gridColumn: 'span 2' }}>
                ...
                <div className="form-group">
                  ...
                  <select value={form.anomalyType} onChange={e => updateField('anomalyType', e.target.value)} required>
                ...
                <div className="form-group">
                  ...
                  <select value={form.engineType} onChange={e => updateField('engineType', e.target.value)} required>
                ...
                <div className="form-group">
                  ...
                  <input type="text" value={form.engineSerialNumber} onChange={e => updateField('engineSerialNumber', e.target.value)} placeholder="e.g. SN-7842" required />
                </div>
                <div className="form-group">
                  <label>Part Number</label>
                  <input type="text" value={form.partNumber} onChange={e => updateField('partNumber', e.target.value)} placeholder="e.g. RB211-9278" />
                </div>
                <div className="form-group">
                  <label>Aircraft Registration</label>
                  <input type="text" value={form.aircraftRegistration} onChange={e => updateField('aircraftRegistration', e.target.value)} placeholder="e.g. G-XWBA" />
                </div>
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <select value={form.mroOrganisation} onChange={e => updateField('mroOrganisation', e.target.value)} required>
                ...
                <div className="form-group">
                  ...
                  <input type="text" value={form.mroSiteLocation} onChange={e => updateField('mroSiteLocation', e.target.value)} placeholder="e.g. Hamburg, Germany" />
                </div>
                <div className="form-group">
                  <label>Shop Visit Reference</label>
                  <input type="text" value={form.shopVisitReference} onChange={e => updateField('shopVisitReference', e.target.value)} placeholder="e.g. SV-2025-LHT-0042" />
                </div>
                <div className="form-group">
                  <label>Submitted By *</label>
                  <input type="text" value={form.submittedBy} onChange={e => updateField('submittedBy', e.target.value)} placeholder="e.g. M. Weber" required />
                </div>
              </div>
