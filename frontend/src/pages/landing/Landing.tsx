        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1.5rem' }}>
            <div className="card">
              ...
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '0.5rem' }}>Digital Request Submission</h3>
              <p style={{ fontSize: '0.875rem', color: 'var(--rr-muted)', lineHeight: 1.6 }}>
            ...
            <div className="card">
              <div style={{ width: '40px', height: '40px', borderRadius: '8px', background: 'var(--rr-navy)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1rem' }}>
                <span style={{ fontSize: '20px' }}>{'\u{1F916}'}</span>
              </div>
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '0.5rem' }}>AI-Assisted Triage</h3>
              <p style={{ fontSize: '0.875rem', color: 'var(--rr-muted)', lineHeight: 1.6 }}>
            ...
            <div className="card">
              ...
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: '0.5rem' }}>Document Authoring Agent</h3>
              <p style={{ fontSize: '0.875rem', color: 'var(--rr-muted)', lineHeight: 1.6 }}>
          ...
          <div style={{ display: 'flex', gap: 0, alignItems: 'stretch', overflowX: 'auto', paddingBottom: '1rem' }}>
            {workflowSteps.map((step, i) => (
              <div className="workflow-step" key={step.name}>
                <div className="step-dot" style={{ background: step.color }}></div>
                <div className="step-content">
                  <h4>{step.name}</h4>
                  <p>{step.description}</p>
                </div>
                {i < workflowSteps.length - 1 && <div className="step-arrow">&#8594;</div>}
              </div>
            ))}
          </div>
        </div>
