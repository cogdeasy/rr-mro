...
function Submit() {
  ...
  useEffect(() => {
    ...
    api.getMroOrganisations().then(setMroOrganisations);
    api.getAnomalyTypes().then(setAnomalyTypes);
  }, []);
  ...
  const onSubmit = (e: FormEvent) => {
    e.preventDefault();
    setSubmitting(true);
    api.createRequest(form as Record<string, unknown>).then(r => {
      setSubmitted(true);
      setSubmitting(false);
            ...
            <form onSubmit={onSubmit}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                <div className="form-group" style={{ gridColumn: 'span 2' }}>
                  ...
                  <input type="text" value={form.title} onChange={e => onChange('title', e.target.value)} placeholder="e.g. HPT Blade Tip Liberation — Trent XWB SN-7842" required />
                </div>
                <div className="form-group" style={{ gridColumn: 'span 2' }}>
                ...
                <div className="form-group">
                  ...
                  <select value={form.anomalyType} onChange={e => onChange('anomalyType', e.target.value)} required>
                ...
                <div className="form-group">
                  ...
                  <select value={form.engineType} onChange={e => onChange('engineType', e.target.value)} required>
                ...
                <div className="form-group">
                  ...
                  <input type="text" value={form.engineSerialNumber} onChange={e => onChange('engineSerialNumber', e.target.value)} placeholder="e.g. SN-7842" required />
                </div>
                <div className="form-group">
                  <label>Part Number</label>
                  <input type="text" value={form.partNumber} onChange={e => onChange('partNumber', e.target.value)} placeholder="e.g. RB211-9278" />
                </div>

                <div className="form-group">
                  <label>Aircraft Registration</label>
                  <input type="text" value={form.aircraftRegistration} onChange={e => onChange('aircraftRegistration', e.target.value)} placeholder="e.g. G-XWBA" />
                </div>
                <div className="form-group">
                  <label>Priority *</label>
                  <select value={form.priority} onChange={e => onChange('priority', e.target.value)} required>
                ...
                <div className="form-group">
                  ...
                  <select value={form.mroOrganisation} onChange={e => onChange('mroOrganisation', e.target.value)} required>
                ...
                <div className="form-group">
                  ...
                  <input type="text" value={form.mroSiteLocation} onChange={e => onChange('mroSiteLocation', e.target.value)} placeholder="e.g. Hamburg, Germany" />
                </div>

                <div className="form-group">
                  <label>Shop Visit Reference</label>
                  <input type="text" value={form.shopVisitReference} onChange={e => onChange('shopVisitReference', e.target.value)} placeholder="e.g. SV-2025-LHT-0042" />
                </div>
                <div className="form-group">
                  <label>Submitted By *</label>
                  <input type="text" value={form.submittedBy} onChange={e => onChange('submittedBy', e.target.value)} placeholder="e.g. M. Weber" required />
                </div>
              </div>
