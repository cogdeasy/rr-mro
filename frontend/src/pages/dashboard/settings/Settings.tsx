      ...
      <div style={{ display: 'grid', gap: '1.5rem', maxWidth: '800px' }}>
        <div className="card">
          ...
          <div style={{ display: 'grid', gap: '1rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem', background: 'var(--rr-platinum)', borderRadius: '0.375rem' }}>
              <div>
                <p style={{ fontSize: '0.8125rem', fontWeight: 500 }}>Initiate Agent</p>
                <p style={{ fontSize: '0.75rem', color: 'var(--rr-muted)' }}>Front-load RFI questions on submission</p>
              </div>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem', background: 'var(--rr-platinum)', borderRadius: '0.375rem' }}>
              <div>
                <p style={{ fontSize: '0.8125rem', fontWeight: 500 }}>Scoping / Triage Agent</p>
                <p style={{ fontSize: '0.75rem', color: 'var(--rr-muted)' }}>Severity classification and specialist routing</p>
              </div>
              <span style={{ fontSize: '0.75rem', fontWeight: 500, color: '#16A34A', background: '#F0FDF4', padding: '0.25rem 0.5rem', borderRadius: '4px' }}>Active</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem', background: 'var(--rr-platinum)', borderRadius: '0.375rem' }}>
              <div>
                <p style={{ fontSize: '0.8125rem', fontWeight: 500 }}>Document Authoring Agent</p>
                <p style={{ fontSize: '0.75rem', color: 'var(--rr-muted)' }}>RAG-powered variance document generation</p>
              </div>
              <span style={{ fontSize: '0.75rem', fontWeight: 500, color: '#16A34A', background: '#F0FDF4', padding: '0.25rem 0.5rem', borderRadius: '4px' }}>Active</span>
            </div>
          </div>
        ...
        <div className="card">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
            <div style={{ padding: '0.75rem', background: 'var(--rr-platinum)', borderRadius: '0.375rem' }}>
              <p style={{ fontSize: '0.75rem', color: 'var(--rr-muted)', marginBottom: '0.25rem' }}>AI Model</p>
              <p style={{ fontSize: '0.8125rem', fontWeight: 500 }}>Azure OpenAI GPT-4</p>
            </div>
            <div style={{ padding: '0.75rem', background: 'var(--rr-platinum)', borderRadius: '0.375rem' }}>
              <p style={{ fontSize: '0.75rem', color: 'var(--rr-muted)', marginBottom: '0.25rem' }}>RAG Platform</p>
              <p style={{ fontSize: '0.8125rem', fontWeight: 500 }}>Databricks</p>
            </div>
            <div style={{ padding: '0.75rem', background: 'var(--rr-platinum)', borderRadius: '0.375rem' }}>
              <p style={{ fontSize: '0.75rem', color: 'var(--rr-muted)', marginBottom: '0.25rem' }}>Knowledge Base</p>
              <p style={{ fontSize: '0.8125rem', fontWeight: 500 }}>15,000+ variances</p>
            </div>
            <div style={{ padding: '0.75rem', background: 'var(--rr-platinum)', borderRadius: '0.375rem' }}>
              <p style={{ fontSize: '0.75rem', color: 'var(--rr-muted)', marginBottom: '0.25rem' }}>Region</p>
              <p style={{ fontSize: '0.8125rem', fontWeight: 500 }}>UK South</p>
            </div>
          </div>
        </div>
          ...
          <div style={{ display: 'grid', gap: '0.75rem' }}>
            {regulations.map(reg => (
              <div key={reg.name} style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', padding: '0.5rem 0', borderBottom: '1px solid var(--rr-border)' }}>
                <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: 'var(--rr-navy)' }}></div>
                <div>
